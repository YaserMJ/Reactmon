      ...
      return (
        <ReactFullpage.Wrapper>
          ...
          <div className="section bkb ">
            ...
            <br />
            <br />
            <h3 className="words2">Hi there!</h3>
            <h4 className="words2">
            ...
            <ul>
              <li>
                <a href="https://www.github.com/YaserMJ">
                  <img
                    className="logos"
              ...
              <li>
                <a href="https://www.facebook.com/Y.Ny95">
                  <img
                    className="logos"
              ...
              <li>
                <a href="https://www.linkedin.com/in/yaser-saleh-1152b6192/">
                  <img
                    className="logos"
              ...
              <li>
                <a href="mailto:YaserMuhammedJaser@gmail.com">
                  <img
                    className="logos"
