      ...
      return (
        <ReactFullpage.Wrapper>
          ...
          <div className="section bkb ">
            <div>
              <img src="https://res.cloudinary.com/teepublic/image/private/s--qpgbnxIN--/t_Preview/b_rgb:ffb81c,c_lpad,f_jpg,h_630,q_90,w_1200/v1556225298/production/designs/4717194_0.jpg" alt=""/>
            </div>
            </div>
        </ReactFullpage.Wrapper>
      );
