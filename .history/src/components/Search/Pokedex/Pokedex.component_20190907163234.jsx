...
class Pkdx extends React.Component{
    constructor(props){
        ...
        this.styles = {
            border: `3px solid ${typeToColor(this.props.type.name)}`,
            color: "black",
            background: typeToColor(this.props.type.name)
        };
    }
    ...
    return (
        <div id="pokedex">
            ...
            <div id="right">
                ...
                <div className='paddieType' style={this.styles} id="yellowBox1">Type : {type}</div>
