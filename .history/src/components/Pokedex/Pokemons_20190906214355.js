...
import './Pokemons.css';
import { openPokemonStyle, closePokemonStyle, showBtn, hideBtn } from "./animationStyle";
import { fetchSinglePokemon, fetchPokemons, fetchPokemonsByColor, searchByName } from "./index";
